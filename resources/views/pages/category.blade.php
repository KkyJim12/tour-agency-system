...
<div class='categoryPage'>
  <div class="banner" style="background:url('{{$category_banner->content}}') no-repeat center center; background-size: cover;">
    <div class="container">
      ...
      <div class="card">
        ...
        <div class="card-body">
          <a class="card-body-link" href="#">
            ...
            <div style="overflow:auto; width:100%; height:90px; align:center;">
