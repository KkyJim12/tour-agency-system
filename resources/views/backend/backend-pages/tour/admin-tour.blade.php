...
<div class="container-fluid">
   <div class="row">
      ...
      <div class="col-md-1 country-filter">
         <input name="country_filter" value="{{$show_country->_id}}" type="checkbox">
         <img src="/assets/img/upload/country/{{$show_country->country_img}}">
         <p>{{$show_country->country_name}}</p>
      </div>
      @endforeach
   </div>
   <div class="row">
         ...
         <table class="table table-bordered table-hover admin-table">
            ...
            <tbody>
               ...
               <tr>
                  ...
                  <td>
                     {{$show_tour->tour_start_date[0]}}
                  </td>
                  <td>
                     {{$show_tour->tour_end_date[0]}}
                  </td>
