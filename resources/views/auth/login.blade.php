...
<body style="background:url('/assets/img/background/background-1.jpg'); background-repeat:no-repeat; background-size:cover">
    <div class="container">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form-group row">
                                <label for="password" class="col-md-4 col-form-label text-md-right">พาสเวิร์ด</label>
