  ...
  <div class="owl-carousel owl-theme">
    ...
    <div class="item">
        <div class="card tour-box">
          ...
          <div class="card-body">
            <a href="/tour/{{$show_tour_discount->_id}}">
              <h5 class="card-title tour-card-title"><strong>{{$show_tour_discount->tour_name}}</strong></h5>
            </a>
            ...
            <div class="row mt-3">
              <span class="col-6">เริ่ม {{$show_tour_discount->tour_price}} บาท</span>
              <img class="col-6 tour-airline-img" src="/assets/img/upload/airline/{{$show_tour_discount->tour_airline_img}}" alt="airline_suggest">
            </div>
            <div class="row mt-3">
              <div class="col-6">
