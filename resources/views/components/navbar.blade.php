         ...
         <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item mr-3 d-lg-none">
              <div class="accordion" id="accordionExample">
                <button type="button" class="btn form-control nav-link text-left" data-toggle="collapse" data-target="#tourlist" aria-expanded="true" aria-controls="tourlist" style="background-color:rgba(0,0,0,.5);">
