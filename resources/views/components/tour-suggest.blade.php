        ...
        <div>
          ...
          <a href='/tour/{{ isset($show_tour_suggest->tour_seo_url) && $show_tour_suggest->tour_seo_url != "" ? $show_tour_suggest->tour_seo_url : $show_tour_suggest->_id }}'>
            ...
            <h2>
              ...
              {{formDateThai(DateTime::createFromFormat('!m', $show_tour_suggest->tour_month)->format('F'))}}
              @else
              {{formatDateThai(DateTime::createFromFormat('!m', $show_tour_suggest->tour_month)->format('F'))}} - {{formatDateThai(DateTime::createFromFormat('!m', $show_tour_suggest->tour_month_last)->format('F'))}}
              @endif
            </h2>
