...
class AdminEditTourController extends Controller
{
    public function AdminEditTourStep($id)
    {
        $tour = Tour::find($id);
        $country = Country::all();
        $airline = Airline::all();
    ...
    public function AdminUpdateTourStep(Request $request, $id)
    {
        /* Validate First */
        ...
        return redirect('/admin/admin-edit-tour-step-1/' . $tour->_id);
    }

    public function AdminEditTourStep1(Request $request, $id)
    {
        $tour = Tour::find($id);
        $holiday = Holiday::all();
        return view('backend.backend-pages.tour.edit-step-1', [
            'tour' => $tour,
            'holiday' => $holiday
        ]);
    }

    public function AdminUpdateTourStep1(Request $request, $id)
    {
        /* Validate First */
        ...
        return redirect('/admin/admin-edit-tour-step-2/' . $tour->_id);
    }

    public function AdminEditTourStep2($id)
    {
        $tour = Tour::find($id);
        return view('backend.backend-pages.tour.edit-step-2', [
            'tour' => $tour
        ]);
    }

    public function AdminUpdateTourStep2(Request $request, $id)
    {
        $tour = Tour::find($id);
    ...
    public function AdminEditTourStep3($id)
    {
        $tour = Tour::find($id);
        return view('backend.backend-pages.tour.edit-step-3', [
            'tour' => $tour,
        ]);
    }

    public function AdminUpdateTourStep3(Request $request, $id)
    {
        $tour = Tour::find($id);
        ...
        return redirect('/admin/admin-edit-tour-step-4/' . $tour->_id);
    }

    public function AdminEditTourStep4($id)
    {
        $tour = Tour::find($id);
        return view('backend.backend-pages.tour.edit-step-4', [
            'tour' => $tour
        ]);
    }

    public function AdminUpdateTourStep4(Request $request, $id)
    {
        $tour = Tour::find($id);
